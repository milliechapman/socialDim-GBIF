...
## Warning in countrycode_convert(sourcevar = sourcevar, origin = origin, destination = dest, : Some values were not matched unambiguously: Baden, Bavaria, Brunswick, German Democratic Republic, Hamburg, Hanover, Hesse-Darmstadt, Hesse-Kassel, Kosovo, Mecklenburg Schwerin, Modena, Nassau, Oldenburg, Parma, Piedmont-Sardinia, Republic of Vietnam, Saxe-Weimar-Eisenach, Saxony, Somaliland, South Yemen, Tuscany, Two Sicilies, Würtemberg, Zanzibar
```
...
## Warning in countrycode_convert(sourcevar = sourcevar, origin = origin, destination = dest, : Some values were not matched unambiguously:  Yemen (North Yemen), Hyderabad, South Vietnam, South Yemen, Yemen (North Yemen)
```
...
![](geopolitics-conflict_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
##   `/home/millie/humanDim-gbif/data/country-boundaries/ne_50m_admin_0_countries.shp' 
...
## `summarise()` has grouped output by 'intensity_level'. You can override using
## the `.groups` argument.
...
![](geopolitics-conflict_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
## Warning: Removed 19 rows containing missing values (geom_col).
```

![](geopolitics-conflict_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](geopolitics-conflict_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
## Joining, by = "countrycode"
## `summarise()` has grouped output by 'countrycode', 'area'. You can override
...
## Delimiter: ","
## chr (6): iso2, iso3, Name, independence_from, cont_ent, cont_suppr
## dbl (3): cow_state, indep_year, timesince
## 
...
![](geopolitics-conflict_files/figure-gfm/conflict-1.png)<!-- -->
